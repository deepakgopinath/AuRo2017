...
\begin{figure}[t]
	\centering
%	\includegraphics[width = 1.12\hsize, center]{./figures/ms_t_j_ha.eps}
...
\begin{figure*}[ht!]
%	\centering
	\includegraphics[ width = 0.8\textwidth, height=0.45\vsize ,center]{./figures/j2_man_disamb_pattern_tight.eps}
%	\caption{}
	\label{fig:j2_man_disamb}
\end{figure*}
\begin{figure*}[ht!]
	\centering
	\includegraphics[ width = 0.8\textwidth ,center]{./figures/ha_man_disamb_pattern_tight.eps}
	\caption{Task compleition times. no statistical difference between times. 
		Couple of reasons. The mode switch request takes 2-3s to process. Secondly, the user spentTask compleition times. no statistical difference between times. 
		Couple of reasons. The mode switch request takes 2-3s to process. Secondly, the user spentTask compleition times. no statistical difference between times. 
		Couple of reasons. The mode switch request takes 2-3s to process. Secondly, the user spent}
