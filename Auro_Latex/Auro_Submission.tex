...
The robot pose and human control command are denoted $\boldsymbol{x}_r$ and $\boldsymbol{u}_h$ respectively and $\boldsymbol{x}_g$ denotes the goal pose for $g \in \mathcal{G}$.
